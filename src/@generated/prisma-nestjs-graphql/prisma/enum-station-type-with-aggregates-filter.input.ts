...
import { NestedEnumStationTypeWithAggregatesFilter } from './nested-enum-station-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumStationTypeFilter } from './nested-enum-station-type-filter.input';

@InputType()
export class EnumStationTypeWithAggregatesFilter {
