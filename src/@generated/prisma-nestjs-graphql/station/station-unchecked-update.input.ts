...
import { PowerTransformerUncheckedUpdateManyWithoutStationInput } from '../power-transformer/power-transformer-unchecked-update-many-without-station.input';

@InputType()
export class StationUncheckedUpdateInput {
    ...
    @Field(() => NullableStringFieldUpdateOperationsInput, {nullable:true})
    areaOfficeId?: NullableStringFieldUpdateOperationsInput;
    ...
    @Field(() => PowerTransformerUncheckedUpdateManyWithoutStationInput, {nullable:true})
    powerTransformer?: PowerTransformerUncheckedUpdateManyWithoutStationInput;
}
